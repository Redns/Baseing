...
public class DrawLineChart extends View {
    ...
    /**折线宽度*/
    private  float mBrokenLineWidth=8;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        /**计算总值*/
        calculateValue= maxValue -minValue;
    ...
    private void DrawBorderLineAndText(Canvas canvas) {
        ...
        for (int i = 0; i < numberLine; i++) {
            ...
            canvas.drawText(floatKeepTwoDecimalPlaces(v)+"",mBrokenLineLeft-dip2px(8),nowadayHeight+mBrokenLineTop,mTextPaint);
        }
    }
